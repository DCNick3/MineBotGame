...
Пример карты. "." - пустота, "X" - стена. Руды отсутствуют.
...
Здание                           | Размер | Энергия | Очки здорвья | За(sh!t)а  | Описание | Функции
---------------------------------|--------|---------|--------------|------------|----------|--------
База (Base)                      | 4x4    | -10+50  | 1000         |    10      | Ваше основное здание. Если оно будет уничтожено – вы проиграете. Работает как склад, генератор, увеличивает максимальное количество юнитов. | Создание юнитов
Склад (Storage)                  | 3x3    | -5      | 200          |    5       | Увеличивает лимит на ресурсы. | Исследование: Межпространственный склад (увеличение вместимости всех складов)
Фабрика Модулей (Module Factory) | 4x4    | -30     | 800          |    10      | Позволяет производить модули для роботов и устанавливать их (сразу). | Производит модули, см. таблицу ниже
Генератор (Generator)            | 2x2    | -10+40  | 100          |    5       | Пассивно генерирует ресурс - энергию | Исследование - квантовая генерация из материи (увеличение мощности всех генераторов)
Пушка (Gun)                      | 2x2    | -15     | 250          |    10      | Бабахает по врагам (Автоматически) | -
Лаборатория (Laboratory)         | 3x3    | -40     | 400          |    5       | Позволяет проводить исследования для создания модулей сложнее, прокаченнее, хороших, годных | Проводит исследования, см. таблицу ниже
### Researches
...
Улучшение            | Вес | Ресурсы      | Энергия* | Требования    | максимальный уровень    | Описание
---------------------|-----|--------------|----------|---------------|-------------------------|---------
Энергоэффективность  | 2   |     ???      | ?        | -             |         5               | Увеличивает эффективность работы энергоустановок
Ускорение бура       | 3   |     ???      | ?        | Добыча        |         3               | Увеличивает скорость копания
Ускорение ББ         | 3   |     ???      | ?        | ББ            |         3               | Увеличивает скорость ближнего боя
Ускорение ДБ         | 4   |     ???      | ?        | ДБ            |         3               | Увеличивает скорость дальнего боя
Шило в попе          | 1   |     ???      | ?        | -             |         5               | Увеличивает скорость движения
Броня                | 4   |     ???      | ?        | -             |         3               | Уменьшает повреждения
Прораб               | 3   |     ???      | ?        | Строительство |         3               | Увеличивает скорость строительства
Радиус видимости     | 5   |     ???      | ?        | -             |         3               | Увеличивает радиус видимости
